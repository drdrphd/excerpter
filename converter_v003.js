...
window.onload = function(){
	...
	function onLoadEAF() {
		...
		//convertToHTML();  //this needs to be called from a user selection
	}
	...
	async function convertToHTML() {
		...
		document.getElementById("export-start-time").innerHTML = selected_lines[0].getAttribute("data-start");
		document.getElementById("export-end-time").innerHTML = selected_lines[selected_lines.length-1].getAttribute("data-end");
		var temp_text = ""
		for (var k of selected_lines) (temp_text += "<br>" + k.innerHTML.substring(k.innerHTML.search("</small>")+8)); //(8 = length of "</small>")
		document.getElementById("export-text").innerHTML = temp_text.substring(4); //without first <br>
			...
			.then(function(){
				...
				document.getElementById("transcript-download").addEventListener('click', function(){
					var download_content =
						...
						+ "text:" + document.getElementById("export-text").innerHTML + ";"
